...
<h1>Welcome to JENKINS CI/CD Build Pipeline Session</h1>
...
<i id="ci" class="fa fa-chevron-right" aria-hidden="true"></i> It is easy to install<br>
<i id="ci" class="fa fa-chevron-right" aria-hidden="true"></i> It has 1000+ plugins to ease your work<br>
<i id="ci" class="fa fa-chevron-right" aria-hidden="true"></i> It is free of cost<br>
<i id="ci" class="fa fa-chevron-right" aria-hidden="true"></i> It is built with Java and hence, it is portable to all the major platforms.</p>
